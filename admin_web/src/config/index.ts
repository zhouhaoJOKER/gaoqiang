...
const appConfig: SystemConfig = {
  ...
  systemInfo: {
    name: 'iStar Pro', // 系统名称
    titleName: 'iStar Pro', // 系统标题
    openCaptcha: false, // 是否开启验证码
    authorName: 'iStar Pro Auth', // 认证系统名称
    authorUrl: 'https://im-erp.com', // 认证系统地址
    logo: '/logo.png', // 系统Logo地址
    favicon: '/logo.png', // 系统ICON地址
    icp: 'ICP 备案号', // ICP 备案号
    policeCode: '公安备案号', // 公安备案号
    versionCode: 'v1.0.0', // 系统版本号
    copyright: 'iStar Pro', // 系统版权信息
    slogan: 'iStar Pro', // 系统标语
    host: 'https://im-erp.com' // 系统地址
  },
  // 系统主题
  systemThemeStyles: {
