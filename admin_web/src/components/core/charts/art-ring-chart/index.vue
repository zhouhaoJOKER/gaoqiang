...
<script setup lang="ts">
  ...
  const { chartRef, isDark, getAnimationConfig, getTooltipStyle, getLegendStyle } =
    useChartComponent({
      ...
      watchSources: [() => props.data, () => props.centerText, () => props.darkBackground],
      generateOptions: (): EChartsOption => {
        ...
        const legendBase = props.showLegend ? getLegendStyle(props.legendPosition) : undefined
        const legendMerged =
          legendBase && props.darkBackground
            ? {
                ...legendBase,
                textStyle: {
                  ...legendBase.textStyle,
                  color: '#ffffff'
                }
              }
            : legendBase
