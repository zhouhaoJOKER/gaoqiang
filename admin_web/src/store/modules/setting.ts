...
import type { SiteInfo } from '@/api/system-manage'
...
export const useSettingStore = defineStore(
  ...
  () => {
    ...
    // 系统信息设置
    /** 系统信息 */
    const systemInfo = ref(AppConfig.systemInfo)
     ...
     * @param info 系统信息
     */
    const updateSystemInfo = (info: SiteInfo) => {
      systemInfo.value = {
        ...systemInfo.value,
        name: info.titleName || systemInfo.value.name,
        titleName: info.titleName || systemInfo.value.titleName,
        openCaptcha: info.openCaptcha || systemInfo.value.openCaptcha,
        authorName: info.authorName || systemInfo.value.authorName,
        authorUrl: info.authorUrl || systemInfo.value.authorUrl,
        logo: info.logo || systemInfo.value.logo,
        favicon: info.favicon || systemInfo.value.favicon,
        icp: info.icp || systemInfo.value.icp,
        policeCode: info.policeCode || systemInfo.value.policeCode,
        versionCode: info.versionCode || systemInfo.value.versionCode,
        copyright: info.copyright || systemInfo.value.copyright,
        slogan: info.slogan || systemInfo.value.slogan,
        host: info.host || systemInfo.value.host
      }
    }
