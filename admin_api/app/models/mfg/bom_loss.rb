class Mfg::BomLoss < ApplicationRecord

    # columns: bom_line_id, loss_mode, loss_value, user_id, updater_id, created_at, updated_at
    ...
    def self.imp_exp_hander
        %w(bom_line_id  loss_mode  loss_value  user_id  updater_id  created_at  updated_at)
    end
