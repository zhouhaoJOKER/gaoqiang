class Mfg::OprateLine < ApplicationRecord

    # columns: operate_id,sort,name,batch_number,qty_kg,user_id,, created_at, updated_at
    # attr_accessor :sort
    # serialize :members
    ...
    #导入导出头部设置
    # Mfg::OprateLine.imp_exp_hander
    def self.imp_exp_hander
        %w(operate_id  sort  name  batch_number  qty_kg  user_id  created_at  updated_at)
    end

    # 示例计算金额
    # Mfg::OprateLine.last.sum_amount("receive_amount", 1000)
