class Pur::Contact < ApplicationRecord

    # columns: supplier_id,name,dept,phone,mobile,email,is_primary,remark,user_id,updater_id,py,, created_at, updated_at
    # attr_accessor :sort
    # serialize :members
    ...
    #导入导出头部设置
    # Pur::Contact.imp_exp_hander
    def self.imp_exp_hander
        %w(supplier_id  name  dept  phone  mobile  email  is_primary  remark  user_id  updater_id  py  created_at  updated_at)
    end

    # 示例计算金额
    # Pur::Contact.last.sum_amount("receive_amount", 1000)
