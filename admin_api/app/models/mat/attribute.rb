class Mat::Attribute < ApplicationRecord

    # columns: user_id, updater_id, company_id, name, py, is_variant, display_type, sort, created_at, updated_at
    # attr_accessor :sort
    # serialize :members
    ...
    #导入导出头部设置
    # Mat::Attribute.imp_exp_hander
    def self.imp_exp_hander
        %w(user_id  updater_id  company_id  name  py  is_variant  display_type  sort  created_at  updated_at)
    end

    # 示例计算金额
    # Mat::Attribute.last.sum_amount("receive_amount", 1000)
